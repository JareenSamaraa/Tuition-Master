							...
							<div class="mobile-menu text-right d-md-none">
								<nav id="mobile-menu">
									<ul>
                                        ...
                                        <ul class="submenu">
													<li><a href="joinTutor"> Sign Up as Tutor</a></li>
													<li><a href="joinParent" class="selected"> Sign Up as Parent</a></li>
        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-img">
                    <img src="pub2/images/signup-img.jpg" alt="">
                </div>
                    ...
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="display_name"> Profile Display Name :</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-select">
                                    <select name="medium" id="medium">
                                        ...
                                        <option value="Both">Both (Bangla & English)</option>
                                    </select>
